...
.dxWeb_isDotSelected
 {
    background-image: url('/DXR.axd?r=1_66-Wsjkf');
    -background-image: url('/DXR.axd?r=1_65-Wsjkf'); /* for IE6 */
...
{
	background-image: url('/DXR.axd?r=1_49-Wsjkf');
}
...
.dxpDropDownButton
{
    ...
    background: #e6e6e6 url('/DXR.axd?r=1_57-Wsjkf') repeat-x top;
    line-height: 0;
}
.dxpHoverDropDownButton
{
    border: 1px solid #606060;
    background: #f2f2f2 url('/DXR.axd?r=1_58-Wsjkf') repeat-x top;
}
...
{
	border: 1px solid #7F7F7F;
	background: #E8E7E8 url('/DXR.axd?r=1_67-Wsjkf') repeat-x;
	cursor: pointer;
	text-align: center;
	padding: 6px;
}
...
{
	background: #F4F4F4 url('/DXR.axd?r=1_69-Wsjkf') repeat-x;
}
...
.dxtcScrollButtonDisabled
{
	cursor: default;
	border-color: #C3C3C3;
	background: #E6E7E8 url('/DXR.axd?r=1_68-Wsjkf') repeat-x;
}
/* Misc */
.dxtcLeftAlignCell,
...
.dxucBrowseButton
{
	padding: 3px 8px 4px;
	border: 1px solid #7F7F7F;
	background: #E0DFDF url('/DXR.axd?r=1_74-Wsjkf') repeat-x top;
}
...
{
	border: 1px solid #606060;
	background: #F2F2F2 url('/DXR.axd?r=1_75-Wsjkf') repeat-x top;
}
...
{
	background: url('/DXR.axd?r=1_64-Wsjkf') repeat;
	font-size: 0px;
	line-height: 0px;
}
.dxsplLCC
...
.dxtvControl .dxtv-ln
{
	background: url('/DXR.axd?r=1_72-Wsjkf') repeat-y;
	vertical-align: top;
}
...
.dxtvControl .dxtv-elb
{
	background: url('/DXR.axd?r=1_70-Wsjkf') no-repeat;
}
...
.dxtvControl.dxtvRtl .dxtv-elb
{
	background-image: url('/DXR.axd?r=1_71-Wsjkf');
}
...
{
	width: 3px;
	background: url('/DXR.axd?r=1_41-Wsjkf') repeat-y right;
	border-width: 0px;
}
...
{
    background-image: url('/DXR.axd?r=1_47-Wsjkf');
    background-repeat: no-repeat;
...
{
    background-image: url('/DXR.axd?r=1_34-Wsjkf');
    -background-image: url('/DXR.axd?r=1_33-Wsjkf'); /* for IE6 */
    background-repeat: no-repeat;
    background-color: transparent;
}
...
{
	background-image:  url('/DXR.axd?r=1_30-Wsjkf');
}
.dxeTBVSys .dxeTBTrack
{
	background-image:  url('/DXR.axd?r=1_31-Wsjkf');
}
...
{
	background-image:  url('/DXR.axd?r=1_20-Wsjkf');
}
.dxeTBVSys .dxeTBBarHighlight
{
	background-image:  url('/DXR.axd?r=1_21-Wsjkf');
}
...
.dxeTBHSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=1_26-Wsjkf');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=1_24-Wsjkf');
}
.dxeTBVSys .dxeTBItem 
{
	background-image:  url('/DXR.axd?r=1_27-Wsjkf');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=1_25-Wsjkf');
}
...
{
	background-image: url('/DXR.axd?r=1_28-Wsjkf');
}
.dxeTBVSys .dxeTBSmallTick
{
	background-image: url('/DXR.axd?r=1_29-Wsjkf');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBLargeTick
{
	background-image: url('/DXR.axd?r=1_22-Wsjkf');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBLargeTick
{
	background-image: url('/DXR.axd?r=1_23-Wsjkf');
}
...
.dxeSpinLargeDecButton
{
	...
	background: #e6e6e6 url('/DXR.axd?r=1_16-Wsjkf') repeat-x top;
}
.dxeSpinIncButton
{
	background: #F0F0F0 url('/DXR.axd?r=1_19-Wsjkf') repeat-x top;
}
.dxeSpinDecButton
{
	background: #E6E6E6 url('/DXR.axd?r=1_18-Wsjkf') repeat-x top;
}
...
{
	font-size: 12px;
	background: #e5e5e5 url('/DXR.axd?r=1_14-Wsjkf') repeat-x top;
...
{
	background: #F2F2F2 url('/DXR.axd?r=1_17-Wsjkf') repeat-x top;
	border: 1px Solid #606060;
}
.dxeCalendarButtonHover
{
	background: url('/DXR.axd?r=1_15-Wsjkf') repeat-x top;
}
...
.dxbButton
{
	...
	vertical-align: middle;
	border: 1px solid #7F7F7F;
	background: #E0DFDF url('/DXR.axd?r=1_12-Wsjkf') repeat-x top;
	padding: 1px;
	cursor: pointer;
}
.dxbButtonHover
{
	color: #000000;
	background: #F2F2F2 url('/DXR.axd?r=1_13-Wsjkf') repeat-x top;
	border: 1px solid #606060;
}
.dxbButtonChecked
{
